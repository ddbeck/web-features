...
function report(stats: Result): string {
  return [
    ...
    "",
    "This is is a time- and browser-weighted measure of unmapped BCD keys. The numbers grows for each day since a key first shipped, per browser. Smaller is better.",
    "",
